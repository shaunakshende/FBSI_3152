...
typedef struct _n_IGAInterface *IGAInterface;
...
//typedef PetscErrorCode (*IGAUserIFunction2)(IGAPoint point,PetscReal dt,  					//Original one
...
typedef PetscErrorCode (*IGAUserIFunction2)(IGAPoint point,PetscReal dt,						//Mine: Vn
                                            PetscReal a,const PetscScalar *A,
                                            PetscReal v,const PetscScalar *V,
                                            PetscReal t,const PetscScalar *U,
                                            PetscScalar *F,const PetscScalar *Vn,
                                            void *ctx);



//typedef PetscErrorCode (*IGAUserIJacobian2)(IGAPoint point,PetscReal dt,  					//Original one
//                                            PetscReal a,const PetscScalar *A,
//                                            PetscReal v,const PetscScalar *V,
//                                            PetscReal t,const PetscScalar *U,
//                                            PetscScalar *J,void *ctx);

typedef PetscErrorCode (*IGAUserIJacobian2)(IGAPoint point,PetscReal dt,						//Mine: Vn
                                            PetscReal a,const PetscScalar *A,
                                            PetscReal v,const PetscScalar *V,
                                            PetscReal t,const PetscScalar *U,
                                            PetscScalar *J,const PetscScalar *Vn,
                                            void *ctx);
...
PETSC_EXTERN PetscErrorCode IGAInterfaceCreate(IGAInterface *interface);
PETSC_EXTERN PetscErrorCode IGAInterfaceDestroy(IGAInterface *interface);
PETSC_EXTERN PetscErrorCode IGAInterfaceReset(IGAInterface interface);
PETSC_EXTERN PetscErrorCode IGAInterfaceReference(IGAInterface interface);
PETSC_EXTERN PetscErrorCode IGAInterfaceInit(IGAInterface interface,PetscInt dof);
PETSC_EXTERN PetscErrorCode IGAInterfaceClear(IGAInterface interface);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetValue(IGAInterface interface,PetscInt field,PetscScalar value);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetLoad (IGAInterface interface,PetscInt field,PetscScalar value);

PETSC_EXTERN PetscErrorCode IGAInterfaceSetUserVector    (IGAInterface interface,IGAUserVector     Vector,    void *ctx);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetUserMatrix    (IGAInterface interface,IGAUserMatrix     Matrix,    void *ctx);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetUserSystem    (IGAInterface interface,IGAUserSystem     System,    void *ctx);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetUserFunction  (IGAInterface interface,IGAUserFunction   Function,  void *ctx);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetUserJacobian  (IGAInterface interface,IGAUserJacobian   Jacobian,  void *ctx);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetUserIFunction (IGAInterface interface,IGAUserIFunction  IFunction, void *ctx);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetUserIJacobian (IGAInterface interface,IGAUserIJacobian  IJacobian, void *ctx);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetUserIFunction2(IGAInterface interface,IGAUserIFunction2 IFunction, void *ctx);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetUserIJacobian2(IGAInterface interface,IGAUserIJacobian2 IJacobian, void *ctx);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetUserIEFunction(IGAInterface interface,IGAUserIEFunction IEFunction,void *ctx);
PETSC_EXTERN PetscErrorCode IGAInterfaceSetUserIEJacobian(IGAInterface interface,IGAUserIEJacobian IEJacobian,void *ctx);
...
struct _p_IGA {
  ...
  IGAInterface interface[3][2];   //mine
  IGABasis    basis[3];
  ...
  PetscInt    property;
  PetscReal   *geometryX;
  PetscReal   *geometryINI; //Initial geometry
  PetscReal   *rationalW;
  PetscScalar *propertyA;
  PetscInt    *type;       // [nel] Element type: Solid or Fluid
  PetscInt    cruz;
  PetscReal   T_wall;      //BC for temperature

  PetscInt  proc_sizes[3];   //Number of processor on each direction
  PetscInt  proc_ranks[3];	 //Number
...
PETSC_EXTERN PetscErrorCode IGAGetInterface(IGA iga,PetscInt i,PetscInt side,IGAInterface *interface);
...
PETSC_EXTERN PetscErrorCode IGAGetLocalVecArrayModified(IGA iga,Vec gvec,Vec *lvec,PetscScalar *array[]);
PETSC_EXTERN PetscErrorCode IGARestoreLocalVecArrayModified(IGA iga,Vec gvec,Vec *lvec,PetscScalar *array[]);
...
struct _n_IGAElement {
  ...
  PetscBool atinterface;
  PetscInt  interface_id;
  /**/
  PetscInt count;
  PetscInt index;
  /**/
  ...
  PetscScalar solidVolume;
  PetscScalar totalDilatationalRateDef;
...
//#############################
PETSC_EXTERN PetscErrorCode IGAElementFixValues0_JB(IGA iga,IGAElement element);
PETSC_EXTERN PetscErrorCode IGAElementFixValues_JB(IGAElement element,PetscScalar U[],PetscScalar V[],PetscScalar A[]);
PETSC_EXTERN PetscErrorCode IGAElementFixFunction_JB(IGAElement element,PetscScalar F[]);
PETSC_EXTERN PetscErrorCode IGAElementFixJacobian_JB(IGAElement element,PetscScalar J[], TS ts);


PETSC_EXTERN PetscErrorCode IGAElementFixValues0_Immerge(IGA iga,IGAElement element);
PETSC_EXTERN PetscErrorCode IGAElementFixValues_Immerge(IGAElement element,PetscScalar U[],PetscScalar V[],PetscScalar A[]);
PETSC_EXTERN PetscErrorCode IGAElementFixFunction_Immerge(IGAElement element,PetscScalar F[]);
PETSC_EXTERN PetscErrorCode IGAElementFixJacobian_Immerge(IGAElement element,PetscScalar J[], TS ts);

/*
PETSC_EXTERN PetscErrorCode IGAElementFixFlux0(IGA iga, IGAElement element);
PETSC_EXTERN PetscErrorCode IGAElementFixValuesA(IGAElement element,PetscScalar U[]);
//#############################
*/
