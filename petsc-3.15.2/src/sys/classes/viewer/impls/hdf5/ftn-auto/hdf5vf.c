...
PETSC_EXTERN void  petscviewerhdf5opengroup_(PetscViewer viewer,hid_t *fileId,hid_t *groupId, int *__ierr)
{
...
PETSC_EXTERN void  petscviewerhdf5hasgroup_(PetscViewer viewer,PetscBool *has, int *__ierr)
{
