...
PETSC_EXTERN void  dmplexlabelcohesivecomplete_(DM dm,DMLabel label,DMLabel blabel,PetscBool *flip,DM subdm, int *__ierr)
{
...
PETSC_EXTERN void  dmplexcreatehybridmesh_(DM dm,DMLabel label,DMLabel bdlabel,DMLabel *hybridLabel,DMLabel *splitLabel,DM *dmInterface,DM *dmHybrid, int *__ierr)
{
...
*__ierr = DMGetEnclosureRelation(
	...
	(DMEnclosureType* )PetscToPointer((rel) ));
}
