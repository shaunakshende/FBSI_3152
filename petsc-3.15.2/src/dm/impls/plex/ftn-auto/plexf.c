...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define dmplexgetcellrefinertype_ DMPLEXGETCELLREFINERTYPE
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define dmplexgetcellrefinertype_ dmplexgetcellrefinertype
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define dmplexsetcellrefinertype_ DMPLEXSETCELLREFINERTYPE
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define dmplexsetcellrefinertype_ dmplexsetcellrefinertype
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void  dmplexgetdepthstratum_(DM dm,PetscInt *stratumValue,PetscInt *start,PetscInt *end, int *__ierr)
{
*__ierr = DMPlexGetDepthStratum(
	(DM)PetscToPointer((dm) ),*stratumValue,start,end);
}
PETSC_EXTERN void  dmplexgetheightstratum_(DM dm,PetscInt *stratumValue,PetscInt *start,PetscInt *end, int *__ierr)
{
...
*__ierr = DMPlexGetCellType(
	...
	(DMPolytopeType* )PetscToPointer((celltype) ));
}
...
PETSC_EXTERN void  dmplexcheckpointsf_(DM dm, int *__ierr)
{
...
PETSC_EXTERN void  dmplexgetcellrefinertype_(DM dm,DMPlexCellRefinerType *cr, int *__ierr)
{
*__ierr = DMPlexGetCellRefinerType(
	(DM)PetscToPointer((dm) ),
	(DMPlexCellRefinerType* )PetscToPointer((cr) ));
}
PETSC_EXTERN void  dmplexsetcellrefinertype_(DM dm,DMPlexCellRefinerType *cr, int *__ierr)
{
*__ierr = DMPlexSetCellRefinerType(
	(DM)PetscToPointer((dm) ),*cr);
}
