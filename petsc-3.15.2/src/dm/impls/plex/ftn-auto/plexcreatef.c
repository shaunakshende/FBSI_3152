...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define dmplexcreatefromcelllistparallel_ DMPLEXCREATEFROMCELLLISTPARALLEL
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define dmplexcreatefromcelllistparallel_ dmplexcreatefromcelllistparallel
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define dmplexcreatereferencecellbytype_ DMPLEXCREATEREFERENCECELLBYTYPE
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define dmplexcreatereferencecellbytype_ dmplexcreatereferencecellbytype
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void  dmplexcreatesquareboundary_(DM dm, PetscReal lower[], PetscReal upper[], PetscInt edges[], int *__ierr)
{
*__ierr = DMPlexCreateSquareBoundary(
	(DM)PetscToPointer((dm) ),lower,upper,edges);
}
PETSC_EXTERN void  dmplexcreatecubeboundary_(DM dm, PetscReal lower[], PetscReal upper[], PetscInt faces[], int *__ierr)
{
...
PETSC_EXTERN void  dmplexcreatehexcylindermesh_(MPI_Fint * comm,PetscInt *numRefine,DMBoundaryType *periodicZ,DM *dm, int *__ierr)
{
...
PETSC_EXTERN void  dmplexcreatefromcelllistparallelpetsc_(MPI_Fint * comm,PetscInt *dim,PetscInt *numCells,PetscInt *numVertices,PetscInt *NVertices,PetscInt *numCorners,PetscBool *interpolate, PetscInt cells[],PetscInt *spaceDim, PetscReal vertexCoords[],PetscSF *vertexSF,DM *dm, int *__ierr)
{
*__ierr = DMPlexCreateFromCellListParallelPetsc(
	MPI_Comm_f2c(*(comm)),*dim,*numCells,*numVertices,*NVertices,*numCorners,*interpolate,cells,*spaceDim,vertexCoords,vertexSF,dm);
}
PETSC_EXTERN void  dmplexcreatefromcelllistparallel_(MPI_Fint * comm,PetscInt *dim,PetscInt *numCells,PetscInt *numVertices,PetscInt *numCorners,PetscBool *interpolate, int cells[],PetscInt *spaceDim, PetscReal vertexCoords[],PetscSF *vertexSF,DM *dm, int *__ierr)
{
*__ierr = DMPlexCreateFromCellListParallel(
	MPI_Comm_f2c(*(comm)),*dim,*numCells,*numVertices,*numCorners,*interpolate,cells,*spaceDim,vertexCoords,vertexSF,dm);
}
...
PETSC_EXTERN void  dmplexcreatefromcelllist_(MPI_Fint * comm,PetscInt *dim,PetscInt *numCells,PetscInt *numVertices,PetscInt *numCorners,PetscBool *interpolate, int cells[],PetscInt *spaceDim, double vertexCoords[],DM *dm, int *__ierr)
{
*__ierr = DMPlexCreateFromCellList(
	MPI_Comm_f2c(*(comm)),*dim,*numCells,*numVertices,*numCorners,*interpolate,cells,*spaceDim,vertexCoords,dm);
}
...
PETSC_EXTERN void  dmplexcreatereferencecellbytype_(MPI_Fint * comm,DMPolytopeType *ct,DM *refdm, int *__ierr)
{
*__ierr = DMPlexCreateReferenceCellByType(
	MPI_Comm_f2c(*(comm)),*ct,refdm);
}
PETSC_EXTERN void  dmplexcreatereferencecell_(MPI_Fint * comm,PetscInt *dim,PetscBool *simplex,DM *refdm, int *__ierr)
{
