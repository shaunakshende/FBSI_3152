...
PETSC_EXTERN void  dmnetworkaddsubnetwork_(DM dm, char* name,PetscInt *nv,PetscInt *ne,PetscInt edgelist[],PetscInt *netnum, int *__ierr, int cl0)
{
*__ierr = DMNetworkAddSubnetwork(
	(DM)PetscToPointer((dm) ),name,*nv,*ne,edgelist,netnum);
}
