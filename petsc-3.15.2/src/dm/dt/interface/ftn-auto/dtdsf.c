...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define petscdsgethybrid_ PETSCDSGETHYBRID
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define petscdsgethybrid_ petscdsgethybrid
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define petscdssethybrid_ PETSCDSSETHYBRID
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define petscdssethybrid_ petscdssethybrid
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void  petscdsgethybrid_(PetscDS prob,PetscBool *isHybrid, int *__ierr)
{
*__ierr = PetscDSGetHybrid(
	(PetscDS)PetscToPointer((prob) ),isHybrid);
}
PETSC_EXTERN void  petscdssethybrid_(PetscDS prob,PetscBool *isHybrid, int *__ierr)
{
*__ierr = PetscDSSetHybrid(
	(PetscDS)PetscToPointer((prob) ),*isHybrid);
}
