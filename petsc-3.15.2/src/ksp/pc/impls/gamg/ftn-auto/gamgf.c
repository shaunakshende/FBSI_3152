...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define pcgamgsetesteigkspmaxit_ PCGAMGSETESTEIGKSPMAXIT
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define pcgamgsetesteigkspmaxit_ pcgamgsetesteigkspmaxit
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void  pcgamgsetesteigkspmaxit_(PC pc,PetscInt *n, int *__ierr)
{
*__ierr = PCGAMGSetEstEigKSPMaxIt(
	(PC)PetscToPointer((pc) ),*n);
}
