...
PETSC_EXTERN void  tssundialssetlineartolerance_(TS ts,double *tol, int *__ierr)
{
...
PETSC_EXTERN void  tssundialssettolerance_(TS ts,double *aabs,double *rel, int *__ierr)
{
