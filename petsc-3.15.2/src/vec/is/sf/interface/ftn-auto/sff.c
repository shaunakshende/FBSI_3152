...
PETSC_EXTERN void  petscsfsetgraph_(PetscSF sf,PetscInt *nroots,PetscInt *nleaves, PetscInt *ilocal,PetscCopyMode *localmode, PetscSFNode *iremote,PetscCopyMode *remotemode, int *__ierr)
{
