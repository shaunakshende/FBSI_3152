...
exec='../ex3'
testname='runex3_1'
label='dm_impls_stag_tutorials-ex3_1'
runfiles=''
...
for insize in ${nsize_in}; do
   ...
   if test $res = 0; then
      petsc_testrun "${diff_exe} /home/shaunak/Desktop/petsc-3.15.2/src/dm/impls/stag/tutorials/output/ex3_1.out ex3_1.tmp" diff-${testname}.out diff-${testname}.out diff-${label} ""
   else
