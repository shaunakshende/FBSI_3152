...
for insize in ${nsize_in}; do
   ...
   if test $res = 0; then
      petsc_testrun "${diff_exe} /home/shaunak/Desktop/petsc-3.15.2/src/dm/impls/plex/tutorials/output/ex9_mesh_1.out ex9_mesh_1.tmp" diff-${testname}.out diff-${testname}.out diff-${label} ""
   else
