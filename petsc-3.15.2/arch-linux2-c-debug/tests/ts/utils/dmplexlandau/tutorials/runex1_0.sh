...
exec='../ex1'
testname='runex1_0'
label='ts_utils_dmplexlandau_tutorials-ex1_0'
runfiles=''
...
for insize in ${nsize_in}; do
   ...
   if test $res = 0; then
      petsc_testrun "${diff_exe} /home/shaunak/Desktop/petsc-3.15.2/src/ts/utils/dmplexlandau/tutorials/output/ex1_0.out ex1_0.tmp" diff-${testname}.out diff-${testname}.out diff-${label} ""
   else
