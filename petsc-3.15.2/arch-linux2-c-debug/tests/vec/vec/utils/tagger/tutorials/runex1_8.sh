...
exec='../ex1'
testname='runex1_8'
label='vec_vec_utils_tagger_tutorials-ex1_8'
runfiles=''
...
for insize in ${nsize_in}; do
   ...
   if test $res = 0; then
      petsc_testrun "${diff_exe} /home/shaunak/Desktop/petsc-3.15.2/src/vec/vec/utils/tagger/tutorials/output/ex1_8.out ex1_8.tmp" diff-${testname}.out diff-${testname}.out diff-${label} ""
   else
