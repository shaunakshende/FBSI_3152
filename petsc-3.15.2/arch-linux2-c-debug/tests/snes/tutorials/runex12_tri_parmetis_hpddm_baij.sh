...
for insize in ${nsize_in}; do
   ...
   if test $res = 0; then
      petsc_testrun "${diff_exe} /home/shaunak/Desktop/petsc-3.15.2/src/snes/tutorials/output/ex12_tri_parmetis_hpddm_baij.out ex12_tri_parmetis_hpddm_baij.tmp" diff-${testname}.out diff-${testname}.out diff-${label} ""
   else
