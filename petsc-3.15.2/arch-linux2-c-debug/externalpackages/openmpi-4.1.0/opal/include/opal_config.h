...
/* Define to 1 if you have the declaration of `PMIX_PACKAGE_RANK', and to 0 if
   you don't. */
#define HAVE_DECL_PMIX_PACKAGE_RANK 0
...
/* Define to 1 if you have the declaration of `ucm_test_external_events', and
   to 0 if you don't. */
#define HAVE_DECL_UCM_TEST_EXTERNAL_EVENTS 0
...
/* Define to 1 if you have the declaration of `ucp_atomic_op_nbx', and to 0 if
   you don't. */
#define HAVE_DECL_UCP_ATOMIC_OP_NBX 0
...
/* Define to 1 if you have the declaration of `ucp_get_nbx', and to 0 if you
   don't. */
#define HAVE_DECL_UCP_GET_NBX 0

/* Define to 1 if you have the declaration of
   `UCP_PARAM_FIELD_ESTIMATED_NUM_PPN', and to 0 if you don't. */
#define HAVE_DECL_UCP_PARAM_FIELD_ESTIMATED_NUM_PPN 0
...
/* Define to 1 if you have the declaration of `ucp_put_nbx', and to 0 if you
   don't. */
#define HAVE_DECL_UCP_PUT_NBX 0
...
/* Define to 1 if you have the declaration of `ucp_tag_recv_nbx', and to 0 if
   you don't. */
#define HAVE_DECL_UCP_TAG_RECV_NBX 0
...
/* Define to 1 if you have the declaration of `ucp_tag_send_nbx', and to 0 if
   you don't. */
#define HAVE_DECL_UCP_TAG_SEND_NBX 0

/* Define to 1 if you have the declaration of `ucp_tag_send_sync_nbx', and to
   0 if you don't. */
#define HAVE_DECL_UCP_TAG_SEND_SYNC_NBX 0
...
#define MCA_io_romio321_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -fPIC -finline-functions -fno-strict-aliasing -mcx16 -pthread -D__EXTENSIONS__' CPPFLAGS='-I/home/shaunak/Desktop/petsc-3.15.2/arch-linux2-c-debug/externalpackages/openmpi-4.1.0/opal/mca/event/libevent2022/libevent -I/home/shaunak/Desktop/petsc-3.15.2/arch-linux2-c-debug/externalpackages/openmpi-4.1.0/opal/mca/event/libevent2022/libevent/include -I/home/shaunak/Desktop/petsc-3.15.2/arch-linux2-c-debug/externalpackages/openmpi-4.1.0/opal/mca/hwloc/hwloc201/hwloc/include   -I/usr/local/include -I/usr/local/include' FFLAGS='-fPIC' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/home/shaunak/Desktop/petsc-3.15.2/arch-linux2-c-debug --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define OMPI_TARBALL_VERSION "4.1.0"
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION 460032

/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 7.5.0
...
#define OPAL_IDENT_STRING "4.1.0"
...
#define OPAL_PACKAGE_STRING "Open MPI shaunak@shaunak-Precision-3630-Tower Distribution"
...
#define OPAL_RELEASE_DATE "Dec 18, 2020"
...
#define OPAL_TARBALL_VERSION "4.1.0"
...
#define ORTE_RELEASE_DATE "Dec 18, 2020"
...
#define OSHMEM_TARBALL_VERSION "4.1.0"
